...
const OnlineCalc = () => {
  return (
    <div className="online-calc">
      <div className="text">
        <h1>Онлайн-калькулятор <br /> стоимости доставки товара</h1>
        <p>
          Задайте необходимые параметры посылки, и калькулятор рассчитает <br />
      ...
      <div className="card">
        ...
        <a href="/">
          <h2 className="online-calc__button">Рассчитать</h2>
        </a>
      </div>
    </div>
  );
