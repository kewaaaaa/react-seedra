    ...
    <div className={style.footerDiv}>
      <div className="container">
        <div className={style.footer}>
          <div className={style.footer__line1}>
            <ul className={style.footer__list1}>
              <li>
                <Link to="/all_prods"> ALL PRODUCTS </Link>
              </li>
              <li>
          ...
          <div className={style.footer__line2}>
            <ul className={style.footer__list2}>
              <li>
                <Link to="/">
                  <InstIcon color=" #359740" />
                </Link>
              </li>
              <li>
                <Link to="/">
                  <FacebookIcon color="#359740" />
                </Link>
              </li>
            </ul>
